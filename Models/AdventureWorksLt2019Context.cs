...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-SSS64FU\\SQLEXPRESS01; Initial Catalog = AdventureWorksLT2019; Integrated Security = True; Encrypt=True;Trust Server Certificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Cart>(entity =>
        {
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Carts)
                ...
                .HasConstraintName("cart_customerid_foreign");
        });

        modelBuilder.Entity<CartItem>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("cartitems_id_primary");
            ...
            entity.HasOne(d => d.Cart).WithMany(p => p.CartItems)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("cartitems_cartid_foreign");

            entity.HasOne(d => d.Product).WithMany(p => p.CartItems)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("cartitems_productid_foreign");
        });
